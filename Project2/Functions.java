...
/*
                                   ...
                                   ImageStore imageStore)
   {
      if (properties.length == FISH_NUM_PROPERTIES)
      {
         ...
         Entity entity = Fish.createFish(properties[FISH_ID], pt,
                                       ...
                                       ImageStore imageStore)
   {
      if (properties.length == ATLANTIS_NUM_PROPERTIES)
      {
         ...
         Entity entity = Atlantis.createAtlantis(properties[ATLANTIS_ID], pt,
                                     ...
                                     ImageStore imageStore)
   {
      if (properties.length == SGRASS_NUM_PROPERTIES)
      {
         ...
         Entity entity = SGrass.createSgrass(properties[SGRASS_ID], pt,
