...
public class PartTwoTestCases
{
   ...
   public void testPerimeters(){
      Circle c = new Circle(new Point(1.2, 5.6), 5.6);
      assertEquals(11.2*Math.PI, c.perimeter(), DELTA);
      Rectangle r = new Rectangle(new Point(0.0, 0.0), new Point(9.0, 2.0));
      assertEquals(22.0, r.perimeter(), DELTA);
      ...
      assertEquals(11.2*Math.PI, Bigger.whichIsBigger(c, r, p), DELTA);
   }
