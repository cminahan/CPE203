...
interface PathingStrategy
{
   ...
   /*List<Point> findPath(Point start, Point end,
                        Predicate<Point> canPassThrough,
                        BiPredicate<Point, Point> withinReach,
                        Function<Point, Stream<Point>> potentialNeighbors, WorldModel world);*/

   /*boolean findPath(Point start, Point end, List<Point> searched,
                    List<Point> path, Predicate<Point> canPassThrough);*/
